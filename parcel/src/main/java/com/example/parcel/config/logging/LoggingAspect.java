package com.example.parcel.config.logging;

import com.example.parcel.utils.AppConstants;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.example.parcel.config.logging.Loggable) || "
        + "@annotation(com.example.parcel.config.logging.Loggable)")
